...
class PdoSeminaire{
	...
	/**
	 * R�cup�re tous les inscrits � une s�ance d'un s�minaire
	 * @param $atelier num�ro de l'atelier concern�
	 * @param $seminaire num�ro du s�minaire concern�
	 */
	...
	/**
	 * R�cup�re tous les inscrits � un s�minaire
	 * @param $seminaire num�ro du s�minaire concern�
	 */
	...
	/**
	 * Retourne un bool�en pour savoir si une personne est inscrite � une s�ance
	 * @param $p la personne � tester
	 * @param $s la s�ance � tester
	 */
